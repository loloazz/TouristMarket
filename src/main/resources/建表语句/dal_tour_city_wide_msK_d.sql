CREATE EXTERNAL TABLE IF NOT EXISTS dal_tour.dal_tour_city_wide_msk_d(
...
location '/daas/motl/dal_tour/dal_tour_city_wide_msk_d'; 


alter table dal_tour.dal_tour_city_wide_msk_d add if not exists partition(day_id='20180503') ;
